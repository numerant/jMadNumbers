...
public class StartAIDuelEvent extends BoardEvent
{
    ...
    public StartAIDuelEvent(final String aiFirstType, final String aiSecondType, final Integer boardSize, final Integer iterationCount)
    {
    ...
    {
        aiDuelSupporter = new AIDuelSupporter(model);
